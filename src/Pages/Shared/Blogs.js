  ...
  return (
    <div>
      <div className='lg:w-[1200px] mx-auto mt-8  bg-gray-50 p-8'>
        <h2 className="text-2xl text-center font-semibold text-white rounded-full bg-green-500 w-fit mx-auto py-2 px-20 ">Blogs</h2>
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - What are the different ways to manage a state in a React application?</h2>
        ...
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - How does prototypical inheritance work?</h2>
        ...
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h2>
        ...
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - How will you improve the performance of a React Application??</h2>
        ...
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
        ...
        <div className='text-left shadow p-4 my-6'>
          <h2 className='text-2xl font-semibold text-green-600 mb-2'>Qs - What is a unit test? Why should write unit tests??</h2>
