...
const Navbar = () => {
  ...
  return (
    ...
    <div className="navbar py-4 shadow-md bg-base-100 sticky top-0 z-50 mb-[5px]">
      <div className="navbar-start lg:ml-24">
        ...
        <Link to='/' className="btn btn-ghost normal-case text-xl w-60"><img src={logo} alt="" /></Link>
        <label tabIndex="1" htmlFor="my-drawer-2" className="btn ml-20 btn-ghost lg:hidden">
